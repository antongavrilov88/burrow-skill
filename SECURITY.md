...
To report a vulnerability in the scripts or installers, open a GitHub issue with the label `security`, or message [@{{TG_HANDLE}}](https://t.me/{{TG_HANDLE}}) if it shouldn't be public yet.
